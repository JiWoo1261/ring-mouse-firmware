...
/**@brief Enum defining Gyroscopes� Full Scale range posibillities in degrees per second. */
typedef enum  {
  GFS_250DPS = 0,
  GFS_500DPS,
  GFS_1000DPS,
...
extern const double ACC_RES;
extern const double GYRO_RES;
